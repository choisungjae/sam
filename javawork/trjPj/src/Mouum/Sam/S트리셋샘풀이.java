...
class TreeSetStud{
	...
	TreeSetStud(String type,int ban, String name, String gender, int... jum) {
		...
		//this.gender = gender;
		this.jum = jum;
		eqArr = new Comparable[] {type,new Integer(ban),gender};
		calcTot();
	}
	...
	void rankCalc(ArrayList arr, int rankNo ) {
		...
		for (Object object : arr) {
			...
			if(avg < you.avg && eqArr[rankNo].equals(you.eqArr[rankNo])) {
				rank++;
			}
		}
	}
...
class TreeStudCom implements Comparator{
	...
	public int compare(Object o1, Object o2) {
		...
		int res = me.eqArr[rankNo].compareTo(you.eqArr[rankNo]);
